...
import zardoni.matteo.AppAndroid.RappresentazioneTimeline.TimelineViewDipendenza;
...
public class TimelineDipendentiActivity extends Activity 
{
	private TimelineViewDipendenza disegnoTimeline;
	...
	//	overridePendingTransition(R.anim.abc_slide_in_top,R.anim.abc_slide_out_bottom);
		this.setContentView(R.layout.timeline_view_dipendenza);
		if(MainActivity.righeSelezionate != null)
		{
			...
			disegnoTimeline = new TimelineViewDipendenza(this);	
	...
	public void onBackPressed()
	{
	    ...
	    {	 
		    ...
		    public void run() 
		    {
            	Intent i = new Intent(TimelineDipendentiActivity.this,
            						MainActivity.class);
		   		startActivity(i);
		        finish();
		    }
